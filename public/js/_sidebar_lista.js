...
(async function(){
  ...
  if(lajson.log){ //utente loggato come agricoltore
    ...
    <div class="w3-sidebar w3-bar-block" style="width:20%; background-color: #00ff2636">
      ...
      <a href="/gestioneAcqua.html" class="w3-bar-item w3-button"><i class="fa-solid fa-droplet"></i> Gestione Acqua</a>
      <a href="/storico.html" class="w3-bar-item w3-button"><i class="fa fa-bar-chart" aria-hidden="true"></i> Storico Acqua Totale</a>
      <a href="/storicoCampo.html" class="w3-bar-item w3-button"><i class="fa fa-bar-chart" aria-hidden="true"></i> Storico Acqua Campo</a>
